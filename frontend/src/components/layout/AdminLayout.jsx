        ...
        <div className="p-4 border-b border-gray-200">
          <Link to="/admin" className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white rounded-full shadow-lg flex items-center justify-center">
              <img src={schoolLogo} alt={schoolName} className="w-6 h-6" />
            </div>
            <span className="text-lg font-bold text-gray-800">
              <span className="text-purple-600">{schoolName}</span>
            </span>
          </Link>
        </div>
        ...
        <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-sm">
          <div className="flex items-center justify-between px-4 py-3 md:px-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="w-8 h-8 rounded-full bg-purple-100 text-purple-600 flex items-center justify-center font-semibold text-sm overflow-hidden">
